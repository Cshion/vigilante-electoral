...
- Data accuracy is critical — electoral data must be validated
- Scraping reliability — ONPE site may change or be unavailable
- Historical data integrity — changes must be tracked accurately

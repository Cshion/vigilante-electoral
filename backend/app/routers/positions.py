...
# NOTE: POST /positions/snapshot was removed (2024-01-XX)
# It was duplicate of POST /api/scrape which has proper auth and better functionality.
# Use POST /api/scrape instead for data population.
